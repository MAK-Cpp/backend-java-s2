...
import static edu.java.bot.commands.Command.NO_TRACKING_LINKS_ERROR;
import static edu.java.bot.commands.Command.UNREGISTERED_USER_ERROR;
import static edu.java.bot.commands.Untrack.ABORTED_MESSAGE;
import static edu.java.bot.commands.Untrack.CANCEL_BUTTON_TEXT;
import static edu.java.bot.commands.Untrack.CONFIRM_MESSAGE_FORMAT;
import static edu.java.bot.commands.Untrack.DESCRIPTION_MESSAGE;
import static edu.java.bot.commands.Untrack.NO_BUTTON_TEXT;
import static edu.java.bot.commands.Untrack.SUCCESS_MESSAGE_FORMAT;
import static edu.java.bot.commands.Untrack.YES_BUTTON_TEXT;
import static edu.java.bot.commands.Untrack.chooseLink;
import static edu.java.bot.commands.Untrack.confirmDelete;
import static edu.java.bot.commands.Untrack.untrack;
